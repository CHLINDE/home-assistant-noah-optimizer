...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            ...
            NoahOptimizerControlEnabledSwitch(
                entry.runtime_data,
                entry,
            ),
        ]
...
class NoahOptimizerControlEnabledSwitch(
    NoahOptimizerEntity,
    SwitchEntity,
):
    ...
    def __init__(
        ...
        self._attr_unique_id = (
            f"{entry.entry_id}_control_enabled"
        )
    ...
    def extra_state_attributes(
        ...
        return {
            "control_status":
                controller.status,
            "last_command_target":
                controller.last_command_target,
            "last_command_at":
                (
                    last_command_at.isoformat()
                    if last_command_at
                    else None
                ),
        }